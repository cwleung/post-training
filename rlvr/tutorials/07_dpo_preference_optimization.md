...
```text
====================================================================================================
               THE MIRACLE OF THE VANISHING PARTITION FUNCTION Z(x)
====================================================================================================
r(x, y_w) =  β log [π_θ(y_w|x) / π_ref(y_w|x)]  +  [ β log Z(x) ]  <-- (無法計算的高維幽靈項)
    -
r(x, y_l) =  β log [π_θ(y_l|x) / π_ref(y_l|x)]  +  [ β log Z(x) ]  <-- (完全相同的題目常數項)
────────────────────────────────────────────────────────────────────────────────────────────────────
Δr        =  β log [π_θ(y_w|x) / π_ref(y_w|x)]  -   β log [π_θ(y_l|x) / π_ref(y_l|x)]  +  0!
                                                                                          ▲
                                                                     相減精準消去！0 積分開銷！
====================================================================================================
```
...
====================================================================================================
                      [ Force 1: Dynamic Spring Scale σ(r_l - r_w) ]
                                            │ (難度自適應衰減)
                      ┌─────────────────────┴─────────────────────┐
                      ▼                                           ▼
       [ Force 2: Attractor 吸力 ]                 [ Force 3: Repeller 斥力 ]
        + ∇_θ log π_θ(y_w | x)                      - ∇_θ log π_θ(y_l | x)
         (拉升獲選回答概率質量)                       (無情壓低落敗回答概率質量)
                      ▲                                           ▲
                      └─────────────┐               ┌─────────────┘
                                    │               │
                      [ Bungee Leash: Anchor to π_ref (Reference Model) ]
====================================================================================================
```
